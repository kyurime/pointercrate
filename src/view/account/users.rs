            ...
            div.left {
                div.panel.fade {
                    ...
                    form.flex.col.pad#patch-permissions novalidate = "" style="display:none" {
                        ...
                        div.flex.no-stretch {
                            input.button.dark-grey.hover#delete-user type = "button" style = "margin: 15px auto 0px;" value="Delete user";
                            input.button.dark-grey.hover type = "submit" style = "margin: 15px auto 0px;" value="Edit user";
                        }
                    }
                }
            }
